...
class ChooseNetworkItem extends StatelessWidget {
  ...
  final ValueChanged<NetworkType> onPressed;

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => onPressed(networkType),
      child: PrimaryCard(
      ...
      child: SizedBox(
        ...
        child: Center(
          child: switch (networkType) {
            NetworkType.ever => Assets.images.everVector.svg(
                width: DimensSizeV2.d16,
                height: DimensSizeV2.d16,
              ),
            NetworkType.venom => Assets.images.venomVector.svg(
                width: DimensSizeV2.d16,
                height: DimensSizeV2.d16,
              ),
            _ => const SizedBox(),
...
class _Name extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PrimaryText(
        switch (networkType) {
          NetworkType.ever => LocaleKeys.everscale.tr(),
          NetworkType.venom => LocaleKeys.venom.tr(),
          _ => '',
        },
...
class _Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PrimaryText(
      switch (networkType) {
        NetworkType.ever => LocaleKeys.chooseNetworkEverDescription.tr(),
        NetworkType.venom => LocaleKeys.chooseNetworkVenomDescription.tr(),
        _ => '',
      },
