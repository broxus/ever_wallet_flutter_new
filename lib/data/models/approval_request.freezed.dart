...
mixin _$ApprovalRequest {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
        ...
        sendMessage,
    required TResult Function(
            Uri origin, int networkId, Completer<ConnectionData> completer)
        changeNetwork,
    required TResult Function(Uri origin, nw.AddNetwork addNetwork,
            bool switchNetwork, Completer<ConnectionData> completer)
        addNetwork,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(
            Uri origin, int networkId, Completer<ConnectionData> completer)?
        changeNetwork,
    TResult? Function(Uri origin, nw.AddNetwork addNetwork, bool switchNetwork,
            Completer<ConnectionData> completer)?
        addNetwork,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$ChangeNetworkImplCopyWith<$Res>
  ...
  @override
  @useResult
  $Res call({Uri origin, int networkId, Completer<ConnectionData> completer});
}
...
class _$ChangeNetworkImpl implements _ChangeNetwork {
  const _$ChangeNetworkImpl(
      {required this.origin, required this.networkId, required this.completer});
  ...
  final int networkId;
  @override
  final Completer<ConnectionData> completer;

  @override
  String toString() {
    return 'ApprovalRequest.changeNetwork(origin: $origin, networkId: $networkId, completer: $completer)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, origin, networkId, completer);
  ...
  TResult when<TResult extends Object?>({
    ...
    return changeNetwork(origin, networkId, completer);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return changeNetwork?.call(origin, networkId, completer);
  }
...
abstract class _ChangeNetwork implements ApprovalRequest {
  const factory _ChangeNetwork(
          ...
          required final Completer<ConnectionData> completer}) =
      _$ChangeNetworkImpl;
  ...
  int get networkId;
  @override
  Completer<ConnectionData> get completer;
  @override
  @JsonKey(ignore: true)
  _$$ChangeNetworkImplCopyWith<_$ChangeNetworkImpl> get copyWith =>
      throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_$AddNetworkImpl(
      origin: null == origin
          ...
          : origin // ignore: cast_nullable_to_non_nullable
              as Uri,
      addNetwork: null == addNetwork
          ? _value.addNetwork
          : addNetwork // ignore: cast_nullable_to_non_nullable
              as nw.AddNetwork,
...
class _$AddNetworkImpl implements _AddNetwork {
  ...
  final Uri origin;
  @override
  final nw.AddNetwork addNetwork;
  @override
  ...
  @override
  String toString() {
    return 'ApprovalRequest.addNetwork(origin: $origin, addNetwork: $addNetwork, switchNetwork: $switchNetwork, completer: $completer)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.origin, origin) || other.origin == origin) &&
            (identical(other.addNetwork, addNetwork) ||
                other.addNetwork == addNetwork) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, origin, addNetwork, switchNetwork, completer);
  ...
  TResult when<TResult extends Object?>({
    ...
    return addNetwork(origin, this.addNetwork, switchNetwork, completer);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return addNetwork?.call(origin, this.addNetwork, switchNetwork, completer);
  }
...
abstract class _AddNetwork implements ApprovalRequest {
  const factory _AddNetwork(
      {required final Uri origin,
      required final nw.AddNetwork addNetwork,
      required final bool switchNetwork,
      required final Completer<ConnectionData> completer}) = _$AddNetworkImpl;

  @override
  Uri get origin;
  nw.AddNetwork get addNetwork;
