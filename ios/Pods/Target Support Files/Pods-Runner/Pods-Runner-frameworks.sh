...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/broxus_app_links/broxus_app_links.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_nekoton_bridge/flutter_nekoton_bridge.framework"
